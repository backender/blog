...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/marc/Sites/blog/app/cache/dev/annotations', true);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'c1001', 'host' => 'backender.ch', 'port' => '3306', 'user' => 'c1001', 'password' => 'mjdiablo', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_e8b8af6646cf958f3790c456d214c99e');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_e8b8af6646cf958f3790c456d214c99e');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_e8b8af6646cf958f3790c456d214c99e');
        ...
        $h->setProxyDir('/Users/marc/Sites/blog/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Users/marc/Sites/blog/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Users/marc/Sites/blog/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Users/marc/Sites/blog/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/marc/Sites/blog/app/cache/dev/sessions', array('lifetime' => 1800, 'auto_start' => true));
    }
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeFileSessionStorage('/Users/marc/Sites/blog/app/cache/dev/sessions', array('lifetime' => 1800, 'auto_start' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/Users/marc/Sites/blog/app/cache/dev/twig', 'charset' => 'UTF-8'));
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Users/marc/Sites/blog/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/marc/Sites/blog/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/marc/Sites/blog/app/cache/dev',
            ...
            'debug.container.dump' => '/Users/marc/Sites/blog/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'profiler.storage.dsn' => 'file:/Users/marc/Sites/blog/app/cache/dev/profiler',
            ...
            'router.resource' => '/Users/marc/Sites/blog/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/marc/Sites/blog/app/cache/dev/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'swiftmailer.spool.memory.path' => '/Users/marc/Sites/blog/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/Users/marc/Sites/blog/app/cache/dev/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Users/marc/Sites/blog/app/cache/dev/doctrine/orm/Proxies',
