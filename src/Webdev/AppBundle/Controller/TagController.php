...
use Webdev\AppBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WebdevBlogBundle:Tag')->findAll();
     ...
     *
     * @Route("/{id}/show", name="admin_tag_show")
     * @Template()
     */
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WebdevBlogBundle:Tag')->find($id);
     ...
     * @Method("post")
     * @Template("WebdevAppBundle:Tag:new.html.twig")
     */
     ...
     *
     * @Route("/{id}/update", name="admin_tag_update")
     * @Method("post")
     * @Template("WebdevAppBundle:Tag:edit.html.twig")
     */
