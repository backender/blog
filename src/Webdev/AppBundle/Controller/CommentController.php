...
use Webdev\AppBundle\Form\CommentType;
...
class CommentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WebdevBlogBundle:Comment')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WebdevBlogBundle:Comment')->find($id);
     ...
     * @Method("post")
     * @Template("WebdevAppBundle:Comment:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("WebdevAppBundle:Comment:edit.html.twig")
     */
