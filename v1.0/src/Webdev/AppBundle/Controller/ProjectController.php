...
use Webdev\BlogBundle\Entity\Project;
use Webdev\AppBundle\Form\ProjectType;
...
class ProjectController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WebdevBlogBundle:Project')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WebdevBlogBundle:Project')->find($id);
     ...
     * @Method("post")
     * @Template("WebdevAppBundle:Project:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("WebdevAppBundle:Project:edit.html.twig")
     */
